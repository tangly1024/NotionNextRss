...
const BLOG = {
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionRSS', // 作者
  BIO: process.env.NEXT_PUBLIC_BIO || '订阅RSS', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rss.tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORDS || 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '888e1581351948b4874e528ed8549e45', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
